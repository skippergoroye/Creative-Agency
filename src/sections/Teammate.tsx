...
const Teammate = () => {
  return (
    <section className="mx-auto container max-w-[1440px] px-6 lg:px-20 lg:mt-20">
      <HeaderTitle title="About" subtitle="Our Teammate" />
      <div className="flex flex-col-reverse lg:flex-row ">
        ...
        <div className="flex flex-1 lg:w-1/2 mb-[40px]">
          <div className="flex flex-col gap-6 mt-10 max-w-[470px] ml-[20px] font-quicksand text-md font-extralight text-graycolor">
            <p>
            ...
            <div className="flex flex-row gap-4">
              <Button type="button" title="About Us" variant="bg-primary text-white" />
              <Button
                type="button"
                title="Our Story"
